  ...
  <div>
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          v-model="text"
          class="w-full h-10 text-lg placeholder:text-gray-400 bg-transparent text-gray-900 border-0 dark:text-white focus:ring-0"
    ...
    <div class="p-4 pl-16">
      <img
        ...
        v-if="inputImageUrl"
        alt=""
        class="border rounded-2xl max-h-40 max-w-[200px]"
